...
export default function EnterpriseDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[var(--surface-container-lowest)] text-[var(--on-surface)] flex flex-col lg:flex-row">
      {/* Sidebar */}
      <aside className="w-full lg:w-64 border-r border-[var(--outline-variant)]/60 bg-[var(--surface-container-low)] flex flex-col z-40">
      ...
      <main className="flex-1 p-6 lg:p-8 space-y-8 overflow-y-auto">
        <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-[var(--outline-variant)]/40 pb-6">
          <div>
            <h1 className="text-2xl font-bold font-display text-[var(--on-surface)]">Enterprise Command Center</h1>
            <p className="text-xs text-[var(--on-surface-variant)]">Real-time organizational wellbeing intelligence & EAP dashboard.</p>
          </div>
          <button className="btn-secondary !text-xs py-2 px-3 flex items-center gap-1.5 self-start sm:self-center">
          ...
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="grid lg:grid-cols-3 gap-6">
                  ...
                  <table className="w-full text-left text-xs border-collapse">
                    <thead>
                      <tr className="border-b border-[var(--outline-variant)] text-[var(--on-surface-variant)]/60">
                        ...
                        <th className="py-2.5 font-semibold">Enrolled Employees</th>
                        <th className="py-2.5 font-semibold">Completion rate</th>
              ...
              <div className="card lg:col-span-1 p-6 space-y-6 flex flex-col justify-between">
                ...
                <div className="border-t border-[var(--outline-variant)]/40 pt-4 flex justify-between text-[11px] text-[var(--on-surface-variant)]">
              ...
              <div className="grid md:grid-cols-2 gap-6 pt-4">
                <div className="space-y-4 p-4 bg-[var(--surface-container-low)] rounded-xl border border-[var(--outline-variant)]/30">
                  ...
                  <div className="space-y-2 text-xs">
                    ...
                    <p className="flex justify-between"><span>Co-pay arrangement</span> <strong>100% Employer Covered</strong></p>
                  </div>
                </div>
                ...
                <div className="space-y-4 p-4 bg-[var(--surface-container-low)] rounded-xl border border-[var(--outline-variant)]/30">
                  ...
                  <div className="space-y-2 text-xs">
                    ...
                    <p className="flex justify-between"><span>Mandatory Wellness Day Triggers</span> <strong>Activated</strong></p>
                  </div>
                </div>
              </div>
            </div>
                ...
                {departmentHealth.map((dept, i) => (
                  <div key={i} className="flex flex-col sm:flex-row justify-between sm:items-center p-4 bg-[var(--surface-container-low)] border-hairline rounded-xl gap-4">
                    <div>
                      ...
                      <p className="text-xs text-[var(--on-surface-variant)]">Size: <strong>{dept.size} employees</strong> &bull; EAP adoption: <strong className="text-indigo-600">{dept.participation}</strong></p>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-xs text-[var(--on-surface-variant)]">Aggregated Burnout Risk:</span>
            ...
            <div className="card p-6 space-y-4">
              ...
              <div className="space-y-3 pt-4">
                {[
                  ...
                  <div key={i} className="flex justify-between items-center p-3 bg-[var(--surface-container-low)] border-hairline rounded-xl text-xs">
                    <div>
                    ...
                    <button className="btn-secondary !py-1.5 !px-3 !text-[11px] flex items-center gap-1">
