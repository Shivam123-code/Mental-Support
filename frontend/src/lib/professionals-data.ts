// Shared static professionals data — no server imports.
// Imported by both the client-side professionals page AND the API route.
...
export type StaticProfessional = typeof STATIC_PROFESSIONALS[0];
