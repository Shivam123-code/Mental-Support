    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link href="/community" className="px-8 py-4 bg-purple-700 text-white font-semibold rounded-full hover:bg-purple-800 transition-all inline-flex items-center gap-2">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature) => (
              <div key={feature.title} className="bg-purple-50 rounded-2xl p-6 border border-purple-100 hover:shadow-md transition-all">
              ...
              <div key={group.name} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all group cursor-pointer">
                <div className="relative h-40 overflow-hidden">
                  ...
                  <div className="absolute bottom-3 left-3 right-3">
                    <p className="text-white text-sm font-medium">{group.members} members</p>
                  </div>
                </div>
                <div className="p-4">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-purple-50 to-amber-50">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Help Someone Today</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={item.label} className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-md transition-all">
