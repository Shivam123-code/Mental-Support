    ...
    <div className="overflow-x-hidden">
                ...
                {category.courses.map((course) => (
                  <div key={course.name} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all border border-gray-100 group cursor-pointer">
                    ...
                    <div className="p-3 sm:p-4 md:p-5">
                      <h3 className="font-semibold text-gray-900 mb-2 text-xs sm:text-sm">{course.name}</h3>
                      <div className="flex items-center gap-3 text-xs text-gray-500 mb-3">
                        <span className="flex items-center gap-1"><Clock size={12} /> {course.duration}</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="font-bold text-sm sm:text-base text-purple-700">{course.price}</span>
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-24 bg-purple-50">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-8 sm:mb-12">Why KleverKlues Academy?</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
            {[
              ...
              <div key={item.title} className="bg-white rounded-xl p-3 sm:p-4 md:p-6">
