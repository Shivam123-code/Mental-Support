        ...
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center gap-3 mb-8 sm:mb-10">
            <div className="w-10 h-10 relative">
              <Image src="/logo.jpeg" alt="KleverKlues" width={40} height={40} className="object-contain" />
            </div>
      ...
      <div className="hidden lg:flex flex-1 bg-[var(--primary)] items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-center px-12 max-w-md">
          <div className="w-20 h-20 mx-auto mb-8 relative opacity-90">
            <Image src="/logo.jpeg" alt="KleverKlues" width={80} height={80} className="object-contain invert brightness-200" />
          </div>
